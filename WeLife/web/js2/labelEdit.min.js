...
typeof JSON != "object" && (JSON = {}), function() {
	...
	function str(a, b) {
		...
		case "string":
			...
			return isFinite(i) ? i + "" : "null";case "boolean":
		case "null":
			return i + "";case "object":
			if (!i) return "null";
			if (gap += indent, h = [], Object.prototype.toString.apply(i) === "[object Array]") {
				for (f = i.length, c = 0; f > c; c += 1) h[c] = str(c, i) || "null";
				return e = h.length === 0 ? "[]" : gap ? "[\n" + gap + h.join(",\n" + gap) + "\n" + g + "]" : "[" + h.join(",") + "]", gap = g, e
			}
			if (rep && typeof rep == "object")
				for (f = rep.length, c = 0; f > c; c += 1) typeof rep[c] == "string" && (d = rep[c], e = str(d, i), e && h.push(quote(d) + (gap ? ": " : ":") + e));
			else
	...
	typeof JSON.stringify != "function" && (JSON.stringify = function(a, b, c) {
		var d;
		if (gap = "", indent = "", typeof c == "number")
			for (d = 0; c > d; d += 1) indent += " ";
		else typeof c == "string" && (indent = c);
		if (rep = b, b && typeof b != "function" && (typeof b != "object" || typeof b.length != "number"))
		...
		function walk(a, b) {
			...
			if (e && typeof e == "object")
				for (c in e) Object.prototype.hasOwnProperty.call(e, c) && (d = walk(e, c), d !== void 0 ? e[c] = d :
						delete e[c]
					);
